...
export default function Login() {
  ...
  return (
    <PhoneFrame>
      <div className="bg-stone-50 min-h-[520px] flex flex-col">
        <div className="bg-emerald-700 px-6 pt-12 pb-10 flex flex-col items-center text-center">
        ...
        <form onSubmit={handleSubmit} className="flex-1 px-6 py-8 flex flex-col gap-4">
          ...
          <button
            ...
            className="mt-2 w-full rounded-2xl bg-emerald-700 py-3.5 text-white font-bold text-[15px] shadow-lg shadow-emerald-700/20 active:scale-[0.98] transition disabled:opacity-60"
          >
