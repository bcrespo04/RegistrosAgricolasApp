...
export default function Menu() {
  ...
  const items = [
    ...
    {
      label: "Ejecución",
      desc: "Registrar labor realizada",
      icon: ClipboardCheck,
    ...
    },
    {
      ...
      desc: "Consultar valores de referencia",
      icon: LayoutGrid,
      color: "bg-amber-50 text-amber-700",
      onClick: () => navigate("/tabla-densidad"),
      disabled: false,
    },
    {
      label: "Usuarios",
      desc: usuario.rol === "Admin" ? "Gestionar accesos" : "Solo administrador",
      icon: Users,
  ...
  return (
    <PhoneFrame>
      <div className="bg-stone-50">
        <div className="bg-emerald-700 px-5 pt-6 pb-8">
        ...
        <div className="px-5 -mt-4 pb-6 space-y-3">
          {items.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-3.5 rounded-2xl bg-white border border-stone-200 px-4 py-4 shadow-sm text-left transition active:scale-[0.98] ${
          ...
          <button
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 text-stone-400 text-[13px] font-medium pt-3"
          >
